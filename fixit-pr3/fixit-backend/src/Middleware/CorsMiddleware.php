...
final class CorsMiddleware implements MiddlewareInterface
{
    ...
    private function applyCors(Response $response, string $allowed, string $origin): Response
    {
        ...
        return $response
            ...
            ->withHeader('Access-Control-Allow-Headers', 'Content-Type, Authorization, X-Sec-Session, X-Sec-Counter, X-Sec-Nonce, X-Sec-Ts, X-Sec-Sign, X-Sec-Body')
            ->withHeader('Access-Control-Expose-Headers', 'X-Sec-Enc')
