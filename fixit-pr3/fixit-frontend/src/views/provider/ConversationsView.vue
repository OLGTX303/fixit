...
const myJobs = computed(() =>
  profile.value ? bookingsStore.forProvider(profile.value.id) : []
)
  ...
  <div class="fx-page">
    ...
    <div class="d-flex flex-column gap-2">
      <button
        ...
        @click="router.push({ name: 'pro-chat', params: { id: b.id } })"
      >
      ...
      <div v-if="!myJobs.length" class="fx-card text-center py-5">
        ...
        <div style="font-size:13px;color:var(--fx-muted)">Accept a booking request to start chatting with customers</div>
