<script setup>
// Icon set mirrored from the mockup (fixit-tokens.jsx FXIcons).
...
<template>
  <!-- v-html is safe here: paths is a static icon lookup table, never user content. -->
  <svg :width="size" :height="size" viewBox="0 0 24 24" fill="none" stroke="currentColor"
       stroke-width="2" stroke-linecap="round" stroke-linejoin="round" v-html="paths[name] || ''" />
</template>
